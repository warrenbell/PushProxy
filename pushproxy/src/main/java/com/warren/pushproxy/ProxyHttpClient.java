...
/**
 * Default implementation of {@link HttpClient} pre-configured for most common
 * use scenarios.
 * <p>
...
public class ProxyHttpClient extends AbstractHttpClient
{
	 ...
	 */
	public ProxyHttpClient(final ClientConnectionManager conman, final HttpParams params)
	{
		super(conman, params);
	}
	 ...
	 * @since 4.1
	 */
	public ProxyHttpClient(final ClientConnectionManager conman)
	{
		super(conman, null);
	}

	public ProxyHttpClient(final HttpParams params)
	{
		super(null, params);
	}
	...
	public static void setDefaultHttpParams(HttpParams params)
	{
		...
		//final VersionInfo vi = VersionInfo.loadVersionInfo("org.apache.http.client", ProxyHttpClient.class.getClassLoader());
